            ...
            <tbody>
                ...
                @foreach ($data_ as $item)
                    ...
                    <tr class="row">
                        ...
                        <td class="col-2 px-0 text-center"><a href="daftarTilik-areadaftartilik" class="text-decoration-none text-black">{{ $dt->area }}</a></td>
                        <td class="col-2 px-0 text-center">{{ $dt->tgl_pelaksanaan->translatedFormat('l, d M Y') }}</td>
                        <td class="col-3 px-0 text-center">{{ $dt->auditor }}</td>
