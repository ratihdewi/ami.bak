...
<div class="row">
    ...
    <table class="table table-hover listAuditee">
        ...
        <tbody>
            @php $no = 1; @endphp
            <tr class="ListAuditee">
                <td class="col-1 text-center">{{ $no++ }}</td>
                <td class="col-6 auditee"><a href="/auditeeBA" class="text-decoration-none text-black">Fakultas Sains dan Ilmu Komputer</a></td>
                <td class="col-2 text-center">2023</td>
              </tr>
            <tr class="ListAuditee">
                <td class="col-1 text-center">{{ $no++ }}</td>
                <td class="col-6 auditee"><a href="/auditeeBA" class="text-decoration-none text-black">Program Studi Ilmu Komputer</a></td>
                <td class="col-2 text-center">2022</td>
            </tr>
