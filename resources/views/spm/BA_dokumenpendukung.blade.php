          ...
          <tbody>
              ...
              <tr>
                ...
                <td class="col-2 text-center">
                  <a href="/BA-deletedokumenpendukung/{{ $dokumenpendukung->id }}" class="mx-2" onclick="return confirm('Apakah Anda yakin akan menghapus dokumen {{ $dokumenpendukung->namaDokumen }} ?')"><button class="btn btn-danger btn-sm"><i class="bi bi-trash text-white h7" title="Hapus"></i></button></a>
                </td>
              </tr>
              @endforeach
          </tbody>
