        ...
        <div id="temuanDT" class="card mt-4 mb-1 mx-4 px-3">
          ...
          <div class="row g-3 mb-4 mx-4">
            <div class="col border rounded px-4 py-4 me-2">
              ...
              <input id="inisialAuditor" type="text" class="form-control" placeholder="Inisial Auditor" aria-label="Masukkan Inisial Auditor" name="inisialAuditor">
            </div>
            <div class="col border rounded px-4 py-4 ms-2">
              <label for="skorAuditor" class="form-label fw-semibold">Skor Auditor</label>
              <input id="skorAuditor" type="number" min="0.00" max="4.00" step="0.01" class="form-control" placeholder="Masukkan Skor Auditor. Contoh: [4.00]" aria-label="Masukkan Skor Auditor" name="skorAuditor">
            </div>
          </div>
        </div>
