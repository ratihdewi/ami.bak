...
@section('linking')
  ...
  <a href="/auditor-editfotokegiatan/{{ $auditees->id }}/{{ $auditees->tahunperiode }}/{{ $pertanyaan_id }}" class="mx-1">
  {{ $auditees->unit_kerja }}
  </a>/
@endsection
    ...
    <div class="topSection d-flex justify-content-around mx-2 mt-4 mb-4"></div>
      ...
      <form id="myForm" action="/storefotokegiatan" method="POST" enctype="multipart/form-data">
        ...
        <div class="simpanBA d-flex justify-content-end">
          <a href="/auditor-daftartilik-tampilpertanyaandaftartilik/{{ $pertanyaan_id }}"><button type="button" class="btn btn-secondary me-md-2">Kembali</button></a>
          ...
          <tbody>
              ...
              <tr>
                ...
                <td class="col text-center">
                  <a href="/lihatfotokegiatan/{{ $fotokegiatan->id }}" class="me-md-2" target="_blank"><button class="bg-warning border-0 rounded-1"><i class="bi bi-eye-fill" title="Buka"></i></button></a>
