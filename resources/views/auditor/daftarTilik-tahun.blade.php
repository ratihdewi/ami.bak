            ...
            <tbody>
                ...
                @foreach ($data_->unique('tahunperiode') as $item)
                    <tr>
                        ...
                        <th class="col-2 text-center"><a href="/auditor-daftartilik/{{ $item->tahunperiode }}" style="text-decoration-line: none; color: black"><button class="bg-warning border-0 rounded-1"><i class="bi bi-eye-fill"></i></button></a></th>
                    </tr>
                @endforeach
            </tbody>
        </table>
