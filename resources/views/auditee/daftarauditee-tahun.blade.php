            ...
            <tbody>
                ...
                @foreach ($dataAuditee->unique('tahunperiode') as $item)
                    <tr>
                        ...
                        <th class="col-2 text-center"><a href="{{ route('auditee-daftarauditee', ['tahunperiode' => $item->tahunperiode]) }}" style="text-decoration-line: none; color: black"><i class="bi bi-eye-fill"></i></a></th>
                    </tr>
                @endforeach
            </tbody>
        </table>
